...
GPO.App = (function () {
  ...
  function route(name) {
    ...
    var r = { dashboard: renderDashboard, suppliers: renderSuppliers, sellout: renderSellout,
      ...
      offers: renderOffers, budgets: renderBudgets, bridge: renderBridge, users: renderUsers }[name];
    if (r) r();
  }
  ...
  function init() {
    // Open-testing warning banner (temporary mode toggle in firebase-config.js)
    var tbn = $('testingBanner'); if (tbn) tbn.hidden = !(GPO.RBAC && GPO.RBAC.openTesting());
